...
def linear_svm(X_train,y_train,MX_test,My_test):
    ...
    Accuracy=metrics.accuracy_score(My_test, y_pred1)
...
def sigmoid_svm(X_train,y_train,MX_test,My_test):
    ...
    Accuracy=metrics.accuracy_score(My_test, y_pred2)
    #matrix=confusion_matrix(My_test, y_pred1)
    report=classification_report(My_test, y_pred2)
    return Accuracy,report
...
def gaussien_svm(X_train,y_train,MX_test,My_test):
    ...
    Accuracy=metrics.accuracy_score(My_test, y_pred)
    #matrix=confusion_matrix(My_test, y_pred1)
...
# plot with various axes scales
    ...
    #pred= predicted.predict_proba(data)[:,1]
